...
\begin{figure}
	...
	\begin{minipage}{.5\textwidth}
			...
			\captionof{figure}{Gender Distribution by \\ Cancer Recurrence}
			\label{fig-gender-dist}
		\end{minipage}%
	\begin{minipage}{.5\textwidth}
			\centering
			\includegraphics[width=1\linewidth]{images/age_dist_plot.png}
			\captionof{figure}{Age Distribution by \\Cancer Recurrence}
			\label{fig-age-dist}
		\end{minipage}
\end{figure}
...
%\centering{
%
%\includegraphics[width=3in,height=\textheight]{images/gender_dist_plot.png}
%
%}
%
...
%	\begin{minipage}{.5\textwidth}
%		\centering
%		\includegraphics[width=2\linewidth]{images/age_dist_plot.png}
%		\captionof{figure}{Age Distribution by Cancer Recurrence}
%		\label{fig-age-dist}
%	\end{minipage}%
%	\begin{minipage}{.5\textwidth}
%		\centering
%		\includegraphics[width=2\linewidth]{images/aden_dist_plot.png}
%		\captionof{figure}{Adenopathy Distribution by cancer recurrence}
%		\label{fig-aden-dist}
%	\end{minipage}
%\end{figure}
...
%\begin{figure}[H]
%
%\centering{\includegraphics[width=4in,height=\textheight]{images/age_dist_plot.png}}
%
...
%\centering{
%
%\includegraphics[width=0.6\linewidth]{images/aden_dist_plot.png}
%
%}
%
