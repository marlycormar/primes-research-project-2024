...
#| tbl-cap: 'RBF SVM Performance Metrics: Accuracy, Precision, Recall, and Specificity.'
#| tbl-alt: 'RBF SVM Performance Metrics: Accuracy, Precision, Recall, and Specificity.'
...
```{r svm-performance-poly, echo=TRUE}
# Use the best fit to make predictions on the test data.
svm_pred2 <- 
  svm_final_fit2 |> 
  tune::collect_predictions() |>
...
#| tbl-cap: 'Polynomial SVM Performance Metrics: Accuracy, Precision, Recall, and Specificity.'
#| tbl-alt: 'Polynomial SVM Performance Metrics: Accuracy, Precision, Recall, and Specificity.'
