...
where $I(y_i \neq \hat{y}_i)$ is an indicator variable that equals $1$ if $y_i \neq \hat{y}_i$ and zero if $y_i = \hat{y}_i$ (i.e., the $i$th observation was classified correctly). The Bayes decision boundary is determines by those observations which conditional probability is exactly $0.5$.
